...
!-------------------------------------------------------------------------
  ...
  ! loop statistics
  max_cool_loopcnt=max(max_cool_loopcnt,int(loopcnt, 8))
contains
  ...
  !-----------------------------------------------------------------------
    ...
    if(isH2) then
       ...
       dxH2 = min(max(dxH2, x_min), 0.5_dp)
    else
       de = 0.0_dp
       dxH2 = 0.0_dp
    endif !if(isH2)
    ...
    if(isHe) then
       ...
       dxHeI = MIN(MAX(dxHeI, x_min),1._dp)
       ! Update xHeII ****************************************************
       ...
       dXion(ixHeII) = MIN(MAX(dXion(ixHeII), x_MIN),1._dp)
       ! Update xHeIII ***************************************************
       ...
       dXion(ixHeIII) = MIN(MAX(dXion(ixHeIII), x_MIN),1._dp)
...
!-------------------------------------------------------------------------
  ...
  ! TODO: checkme, but it seems this fails for 0 ions!
