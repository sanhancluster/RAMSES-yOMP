...
!$omp parallel do private(ngrid,ind_grid,iskip,ind_cell,nleaf,ind_leaf,uu,gg,dt_lev) &
!$omp & reduction(+:mass_loc,ekin_loc,eint_loc) reduction(MIN:dt_loc) schedule(static)
